          ...
          <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 text-center">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-slate-700 dark:hover:bg-slate-600 text-gray-900 dark:text-white rounded-lg transition-colors"
              >
                Refresh Page
              </button>
            </div>
